...
<footer class="footer bg-dark text-white pt-5 pb-4">
    ...
    <script type="application/ld+json">
    {
      ...
      "potentialAction": {
        ...
        "target": {
          "@type": "EntryPoint",
          "urlTemplate": "https://greenwoodphilippines.com/catalog.php?search={search_term_string}"
        },
    ...
    <div class="container">
        ...
        <div class="text-center text-white-50">
            <p class="mb-0">&copy; <?php echo date('Y'); ?> Greenwood Philippines. All rights reserved.</p>
        </div>
    </div>
</footer>